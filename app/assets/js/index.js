(() => {
  ...
  // elm:/Users/dzenis.madzovic/Desktop/Other Projects/MeetApp/app/assets/elm/src/Main.elm
  var require_Main = __commonJS({
    "elm:/Users/dzenis.madzovic/Desktop/Other Projects/MeetApp/app/assets/elm/src/Main.elm"(exports) {
      (function(scope) {
        "use strict";
        ...
        var $author$project$Main$init = { isDataNav: false };
        ...
        var $author$project$Main$update = F2(
          function(msg, model) {
            return _Utils_update(
              model,
              { isDataNav: !model.isDataNav }
            );
          }
        );
        var $author$project$Main$ToggleDataNav = { $: "ToggleDataNav" };
        var $elm$html$Html$i = _VirtualDom_node("i");
        var $author$project$Main$mainCard = F2(
          function(isNav, image) {
            var changePosition = isNav ? A2($elm$html$Html$Attributes$style, "transform", "translateY(-50%)") : A2($elm$html$Html$Attributes$style, "", "");
            return A2(
              $elm$html$Html$div,
              _List_fromArray(
                [
              ...
              _List_fromArray(
                [
                  A2(
                    ...
                    _List_fromArray(
                      [
                        $elm$html$Html$Attributes$class("nav-link-label rubik-font")
                      ]
                    ),
                    _List_fromArray(
                      [
                  ...
                  A2(
                    ...
                    _List_fromArray(
                      [
                        $elm$html$Html$Attributes$class("nav-link-image"),
        ...
        var $author$project$Main$navBar = function(isNav) {
          var changePosition = isNav ? A2($elm$html$Html$Attributes$style, "transform", "translateY(0%) scale(1)") : A2($elm$html$Html$Attributes$style, "", "");
          return A2(
            $elm$html$Html$nav,
            _List_fromArray(
              [
            ...
            _List_fromArray(
              [
                A2(
                  ...
                  _List_fromArray(
                    [
                      A2($author$project$Main$navLinks, "Stockholm", "https://picsum.photos/1600/500"),
                      A2($author$project$Main$navLinks, "Malmo", "https://picsum.photos/1600/500"),
                      A2($author$project$Main$navLinks, "Coppenhagen", "https://picsum.photos/1600/500"),
                      A2($author$project$Main$navLinks, "Lund", "https://picsum.photos/1600/500"),
                      A2($author$project$Main$navLinks, "Helsingborg", "https://picsum.photos/1600/500"),
                      A2($author$project$Main$navLinks, "Hell", "https://picsum.photos/1600/500")
                    ]
                  )
                )
              ]
        ...
        var $author$project$Main$view = function(model) {
          return A2(
            ...
            _List_fromArray(
              [
                A2($author$project$Main$mainCard, model.isDataNav, "https://picsum.photos/3840/2160"),
                $author$project$Main$navBar(model.isDataNav),
                A2(
                  $elm$html$Html$button,
                  _List_fromArray(
                    [
                      ...
                      $elm$html$Html$Events$onClick($author$project$Main$ToggleDataNav)
                    ]
                  ),
                  _List_fromArray(
                    [
                      model.isDataNav ? A2(
                        ...
                        _List_fromArray(
                          [
                            $elm$html$Html$Attributes$class("close fa-solid fa-xmark")
                          ]
                        ),
                        _List_Nil
                      ) : A2(
                        ...
                        _List_fromArray(
                          [
                            $elm$html$Html$Attributes$class("open fa-solid fa-bars-staggered")
                          ]
                        ),
                        _List_Nil
                      )
        ...
        )({ "versions": { "elm": "0.19.1" }, "types": { "message": "Main.Msg", "aliases": {}, "unions": { "Main.Msg": { "args": [], "tags": { "ToggleDataNav": [] } } } } }) } });
      })(exports);
    }
  });
